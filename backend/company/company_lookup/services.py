...
from company.company_lookup.providers.website_provider import get_website_information, get_website_information_from_url
...
def lookup_company(
    ...
    if website:
        ...
        website_data = get_website_information_from_url(
