...
class EligibilityService:
    ...
    def get_eligible_banks(self, db, request):
        ...
        for bank in banks:
            ...
            print("User Employment :", repr(request.employment_type))
            print("Bank Employment :", bank["employment_types"])

            if request.employment_type not in bank["employment_types"]:
                print("Employment Failed")
            ...
            # Property Type Check
            print("User Property :", repr(request.property_type))
            print("Bank Property:", bank["property_types"])
    ...
    def recommend(self, db, request):
        ...
        for bank in top_banks:
            ...
            emi = self.emi_service.calculate_emi(
                ...
                tenure_years=bank["max_tenure"] / 12
            )
